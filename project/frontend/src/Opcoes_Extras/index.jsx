    ...
    <div>
      ...
      <div>
        {opcoes.map((texto, index) => (
          <div 
            key={index}
            className="bg-gradient-to-r from-[rgba(255,208,147)] to-[rgba(235,175,255)] p-0.5 rounded mb-4 w-fit hover:shadow-xl transition transform duration-300 hover:-translate-y-1"
          >
            <button
              className="hover:cursor-pointer bg-black text-white rounded p-2 text-x opacity-70"
